...
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (UITableViewCell * _Nonnull)setUpTableviewCellUI:(UITableViewCell * _Nonnull)cell;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
@property (nonatomic) BOOL userSelectingAdditionalRoutes;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified cancelButton;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified etaLabel;
@property (nonatomic, strong) IBOutlet UIView * _Null_unspecified guidanceContainer;
...
- (void)setUpGuidanceUI:(BOOL)enabled;
- (void)getLocation;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)findClosestMapItemMatchingTask:(Task * _Nonnull)task userLocation:(CLLocation * _Nonnull)userLocation;
