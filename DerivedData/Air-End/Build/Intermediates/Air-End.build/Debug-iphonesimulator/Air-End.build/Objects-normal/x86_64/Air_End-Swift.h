...
@property (nonatomic, copy) NSDictionary<NSString *, MKMapItem *> * _Nonnull closeMapItems;
@property (nonatomic, copy) NSArray<MKRoute *> * _Nonnull sourceRoutes;
@property (nonatomic, copy) NSArray<MKRoute *> * _Nonnull destinationRoutes;
@property (nonatomic, copy) NSDictionary<NSNumber *, NSDictionary<MKRoute *, MKRoute *> *> * _Nonnull finalRoutes;
...
- (void)showRoute;
- (void)setUpGuidanceTapGestureRegcognizer;
- (void)hideGuidance;
...
- (void)didTapPolyline:(MKPolyline * _Nonnull)sender;
@end
...
- (MKMapItem * _Nullable)findDestinationMapItemOfRoute:(MKRoute * _Nullable)route;
- (void)searchForFastestRouteBetweenTasks:(NSArray<MKMapItem *> * _Nonnull)sortedTasks;
...
SWIFT_CLASS("_TtC7Air_End11TaskMapView")
@interface TaskMapView : MKMapView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)handleMapTapOnce:(UITapGestureRecognizer * _Nonnull)tapOnce;
@end
...
- (void)searchForFastestRouteFromSourceToDestination:(MKDirections * _Nonnull)directions withCompletionHandler:(void (^ _Nonnull)(MKRoute * _Nullable))handler;
