...
- (void)animateCell:(UITableViewCell * _Nonnull)cell;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section;
@end
...
- (void)enRouteUI;
- (void)setUpMapUI;
- (void)destinationUI:(BOOL)isHidden;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
...
- (NSArray<MKMapItem *> * _Nullable)sortMapItemsCloseToUserLocation:(MKMapItem * _Nonnull)userLocation mapItems:(NSArray<MKMapItem *> * _Nonnull)mapItems;
@end
