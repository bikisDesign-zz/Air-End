...
SWIFT_CLASS("_TtC7Air_End8Guidance")
...
- (void)goAgain:(MKMapItem * _Nonnull)source destination:(MKMapItem * _Nonnull)destination sourceToDestinationRoute:(MKRoute * _Nonnull)sourceToDestinationRoute index:(NSInteger)index;
- (void)showRoute;
- (void)hideGuidance;
- (void)plotPolylineWithRoute:(MKRoute * _Nonnull)route;
